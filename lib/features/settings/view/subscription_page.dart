...
import 'package:zeeve/features/settings/widgets/subscriptionTiles.dart';
...
class _SubscriptionPageState extends State<SubscriptionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget planTiles(String label, String content) {
      return Container(
    ...
    return Scaffold(
      body: Container(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              planTiles("Total Monthly Subscription", "\$0"),
              planTiles("Current Plan", "Standard"),
              // planTiles(),
